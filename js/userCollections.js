...
var subpages = ["favoriteNews.html",
	"favoriteThreads.html",
	"favoriteQuestions.html"
];
var subpage_style = {
	top: "100px",
	bottom: "0px"
...
mui('.mui-scroll').on('tap', 'a', function(e) {
	...
	if(mui.os.plus) {
		...
		if(detailPage.id == "favoriteThreads.html" && !favoriteThreads) {
			mui.fire(detailPage, 'show', {
				show: true
			})
			favoriteThreads = true;
		}
